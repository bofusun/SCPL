...
class analyse():
    ...
    def evaluate_train_once(self, agent_name, agent, critic):
        ...
        for i in range(1):
            ...
            while not done:
                ...
                print("action", action)
                self.record_image(critic, obs1, action, 0.97, self.video1, self.video1_mask)
                self.record_image(critic, obs1, action, 0.98, self.video2, self.video2_mask)
            ...
            self.video1.save(self.task_name + agent_name +'train_mask_097_%d.mp4' % i)
            self.video1_mask.save(self.task_name + agent_name +'train_masked_097_%d.mp4' % i)
            self.video2.save(self.task_name + agent_name +'train_mask_098_%d.mp4' % i)
            self.video2_mask.save(self.task_name + agent_name +'train_masked_098_%d.mp4' % i)
    ...
    def evaluate_color(self, agent_name, agent, critic):
        ...
        for i in range(10):
            ...
            self.video1.save(self.task_name + agent_name +'color_mask_097_%d.mp4' % i)
            self.video1_mask.save(self.task_name + agent_name +'color_masked_097_%d.mp4' % i)
            self.video2.save(self.task_name + agent_name +'color_mask_098_%d.mp4' % i)
            self.video2_mask.save(self.task_name + agent_name +'color_masked_098_%d.mp4' % i)
        episode_rewards = np.array(episode_rewards)
    ...
    def evaluate_veasy(self, agent_name, agent, critic):
        ...
        for i in range(10):
            ...
            self.video1.save(self.task_name + agent_name +'veasy_mask_097_%d.mp4' % i)
            self.video1_mask.save(self.task_name + agent_name +'veasy_masked_097_%d.mp4' % i)
            self.video2.save(self.task_name + agent_name +'veasy_mask_098_%d.mp4' % i)
            self.video2_mask.save(self.task_name + agent_name +'veasy_masked_098_%d.mp4' % i)
        episode_rewards = np.array(episode_rewards)
    ...
    def evaluate_vhard(self, agent_name, agent, critic):
        ...
        for i in range(10):
            ...
            self.video1.save(self.task_name + agent_name +'vhard_mask_097_%d.mp4' % i)
            self.video1_mask.save(self.task_name + agent_name +'vhard_masked_097_%d.mp4' % i)
            self.video2.save(self.task_name + agent_name +'vhard_mask_098_%d.mp4' % i)
            self.video2_mask.save(self.task_name + agent_name +'vhard_masked_098_%d.mp4' % i)
        episode_rewards = np.array(episode_rewards)
