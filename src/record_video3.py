...
class analyse():
    def __init__(self, param, device):
        ...
        self.work_dir = os.path.join(param.work_dir, 'analyse_video2')
        ...
        self.video4 = VideoRecorder_new(self.work_dir if self.save_video else None, height=448, width=448)
        ...
        self.video4_mask = VideoRecorder_new(self.work_dir if self.save_video else None, height=448, width=448)
        self.device = device
        # 环境设置
        ...
        if self.task_name == "stand":
            ...
            self.temp_agent = self.make_agent("sgsac83")
            self.temp_agent.actor.load_state_dict(torch.load('/root/deeplearningnew/sun/rl_generalization/dmcontrol-generalization-benchmark-main/draw_new/all_pt/cartpole/88/0/actor_400000.pt'))
            self.temp_agent.critic.load_state_dict(torch.load('/root/deeplearningnew/sun/rl_generalization/dmcontrol-generalization-benchmark-main/draw_new/all_pt/cartpole/88/0/critic_400000.pt'))
            self.agent = self.make_agent("sgsac83")
            ...
            self.temp_agent.critic.load_state_dict(torch.load('/root/deeplearningnew/sun/rl_generalization/dmcontrol-generalization-benchmark-main/draw_new/all_pt/ball/83/0/critic_400000.pt'))
            self.agent = self.make_agent("sgsac83")
            ...
            self.agent_sgqn = self.make_agent("sgsac")
            self.agent_sgqn.actor.load_state_dict(torch.load('/root/deeplearningnew/sun/rl_generalization/dmcontrol-generalization-benchmark-main/draw_new/all_pt/ball/sgsac/2/actor_400000.pt'))
            self.agent_sgqn.critic.load_state_dict(torch.load('/root/deeplearningnew/sun/rl_generalization/dmcontrol-generalization-benchmark-main/draw_new/all_pt/ball/sgsac/2/critic_400000.pt'))
            self.agent_sgqn1 = self.make_agent("sgsac")
            self.agent_sgqn1.critic.load_state_dict(torch.load('/root/deeplearningnew/sun/rl_generalization/dmcontrol-generalization-benchmark-main/draw_new/all_pt/ball/sgsac/1/critic_400000.pt'))
            self.agent_sac = self.make_agent("sac")
            ...
            self.temp_agent = self.make_agent("sgsac83")
            self.temp_agent.actor.load_state_dict(torch.load('/root/deeplearningnew/sun/rl_generalization/dmcontrol-generalization-benchmark-main/draw_new/all_pt/finger/88/0/actor_400000.pt'))
            self.temp_agent.critic.load_state_dict(torch.load('/root/deeplearningnew/sun/rl_generalization/dmcontrol-generalization-benchmark-main/draw_new/all_pt/finger/88/0/critic_400000.pt'))
            self.agent = self.make_agent("sgsac83")
    ...
    def evaluate_train_once(self, agent_name, agent, critic):
        ...
        for i in range(1):
            ...
            self.video3.init(enabled=(True))
            self.video4.init(enabled=(True))
            self.video1_mask.init(enabled=(True))
            self.video2_mask.init(enabled=(True))
            self.video3_mask.init(enabled=(True))
            self.video4_mask.init(enabled=(True))
            done = False
            episode_reward = 0
            # 开始一个episode
            while not done:
                ...
                self.record_image(critic, obs1, action, 0.97, self.video3, self.video3_mask)
                self.record_image(critic, obs1, action, 0.98, self.video4, self.video4_mask)
            ...
            self.video3.save(self.task_name + agent_name +'train_mask_097_%d.mp4' % i)
            self.video3_mask.save(self.task_name + agent_name +'train_masked_097_%d.mp4' % i)
            self.video4.save(self.task_name + agent_name +'train_mask_098_%d.mp4' % i)
            self.video4_mask.save(self.task_name + agent_name +'train_masked_098_%d.mp4' % i)
    ...
    def evaluate_color(self, agent_name, agent, critic):
        ...
        for i in range(10):
            ...
            self.video3.save(self.task_name + agent_name +'color_mask_097_%d.mp4' % i)
            self.video3_mask.save(self.task_name + agent_name +'color_masked_097_%d.mp4' % i)
            self.video4.save(self.task_name + agent_name +'color_mask_098_%d.mp4' % i)
            self.video4_mask.save(self.task_name + agent_name +'color_masked_098_%d.mp4' % i)
        episode_rewards = np.array(episode_rewards)
    ...
    def evaluate_veasy(self, agent_name, agent, critic):
        ...
        for i in range(10):
            ...
            self.video3.save(self.task_name + agent_name +'veasy_mask_097_%d.mp4' % i)
            self.video3_mask.save(self.task_name + agent_name +'veasy_masked_097_%d.mp4' % i)
            self.video4.save(self.task_name + agent_name +'veasy_mask_098_%d.mp4' % i)
            self.video4_mask.save(self.task_name + agent_name +'veasy_masked_098_%d.mp4' % i)
        episode_rewards = np.array(episode_rewards)
    ...
    def evaluate_vhard(self, agent_name, agent, critic):
        ...
        for i in range(10):
            ...
            self.video3.save(self.task_name + agent_name +'vhard_mask_097_%d.mp4' % i)
            self.video3_mask.save(self.task_name + agent_name +'vhard_masked_097_%d.mp4' % i)
            self.video4.save(self.task_name + agent_name +'vhard_mask_098_%d.mp4' % i)
            self.video4_mask.save(self.task_name + agent_name +'vhard_masked_098_%d.mp4' % i)
        episode_rewards = np.array(episode_rewards)
    ...
    def evaluate_all(self):
        ...
        # # sgqn
        # agent_name = "sgqn"
        # self.evaluate_train_once(agent_name, self.agent_sgqn, self.agent_sgqn1.critic)
        ...
        # self.evaluate_vhard(agent_name, self.agent_sgqn, self.agent_sgqn1.critic)
