...
FORMAT_CONFIG = {
    'rl': {
        'train': [
            ...
            ('critic_loss1', 'CLOSS1', 'float'),('critic_loss2', 'CLOSS2', 'float'),
            ('q_cur', 'Q_CUR', 'float'),('q_aug', 'Q_AUG', 'float'),('q_mse', 'Q_MSE', 'float'),('tq', 'tQ', 'float'),
            ('aux_loss', 'AUXLOSS', 'float'),('kl_loss', 'KLLOSS', 'float'),('embedding_mse', 'EM_MSE', 'float')
        ],
        "eval": [
            ("step", "S", "int"),
