...
def parse_args():
    ...
    parser.add_argument('--workdir', default='2024_new')
    parser.add_argument('--seed', default=1, type=int)
    parser.add_argument('--algorithm', default='svea', type=str, choices=['sac', 'rad', 'curl', 'pad', 'soda', 'soda1', 'drq', 'svea', "sgsac", 'svea_value', 'svea_kl', \
                                                                          ...
                                                                          "sgsac97", "sgsac98", "sgsac99", "sgsac101", "sgsac102", "sgsac103", "sgsac104", "sgsac105",'svea2', 'svea3', 'svea4', 'svea5', 'svea6'])
        ...
        for step in range(self.train_steps):
            if done:
                ...
                if episode % self.eval_freq == 0:
                    ...
                    # 保存记录
                    save_info = {"train_rewards": self.train_rewards}
                    save_info.update(self.test_rewards)
