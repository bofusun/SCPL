...
# stand
SAC = [1.4172494, 1.1373985, 3.8237305]
SAC_C= [1.0973594, 0.25811297, 0.7150348]
SVEA = [0.72332615, 0.07037337, 0.30943853]
SGQN = [1.7297351, 0.10700784, 0.87343234]
SCPL = [0.10369893, 0.015229588, 0.036519416]
...
ax1.bar(bar_positions + 3 * bar_width, SCPL, width=bar_width, label='SCPL (ours)', color=colors[3], edgecolor='none')
...
ax2.vlines(bar_positions + 3 * bar_width, ymin=0, ymax=rSCPL, color="black", linewidth=linewidth)
...
plt.hlines(rSCPL, xmin= bar_positions + 3*bar_width - hline_width, xmax= bar_positions + 3*bar_width + hline_width, color="black", linewidth=linewidth)
...
# 保存图像
plt.savefig('/root/deeplearningnew/sun/rl_generalization/dmcontrol-generalization-benchmark-main/draw_new/bar_chart_stand.png')
plt.savefig('/root/deeplearningnew/sun/rl_generalization/dmcontrol-generalization-benchmark-main/draw_new/bar_chart_stand.pdf', dpi=600)
