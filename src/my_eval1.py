...
class MODEL():
    def __init__(self, param, device):
        ...
        if self.task_name == "stand":
            self.agent.actor.load_state_dict(torch.load('/root/deeplearningnew/sun/rl_generalization/dmcontrol-generalization-benchmark-main/draw_new/all_pt/stand/83/3/actor_400000.pt'))
            # self.agent_74 = self.make_agent("sgsac74") 0 4
            ...
            self.agent.actor.load_state_dict(torch.load('/root/deeplearningnew/sun/rl_generalization/dmcontrol-generalization-benchmark-main/615_save_grad_overlay_11layer/walker_walk/sgsac83/3/model/actor_400000.pt'))
            # self.agent_74 = self.make_agent("sgsac74") 4
            ...
            self.agent.actor.load_state_dict(torch.load('/root/deeplearningnew/sun/rl_generalization/dmcontrol-generalization-benchmark-main/draw_new/all_pt/cartpole/88/2/actor_400000.pt'))
            # self.agent_74 = self.make_agent("sgsac74") 0
            ...
            self.agent.actor.load_state_dict(torch.load('/root/deeplearningnew/sun/rl_generalization/dmcontrol-generalization-benchmark-main/draw_new/all_pt/ball/83/1/actor_400000.pt'))
            # self.agent_74 = self.make_agent("sgsac74") 0
            ...
            self.agent.actor.load_state_dict(torch.load('/root/deeplearningnew/sun/rl_generalization/dmcontrol-generalization-benchmark-main/draw_new/all_pt/finger/88/1/actor_400000.pt'))
            # self.agent = self.make_agent("sgsac74") 0
            # self.agent.actor.load_state_dict(torch.load('/root/deeplearningnew/sun/rl_generalization/dmcontrol-generalization-benchmark-main/draw_new/all_pt/finger/74/0/actor_400000.pt'))
            # self.agent = self.make_agent("sgsac67")
            # self.agent.actor.load_state_dict(torch.load('/root/deeplearningnew/sun/rl_generalization/dmcontrol-generalization-benchmark-main/draw_new/all_pt/finger/92/0/actor_400000.pt'))
    ...
    def evaluate(self, env, step, eval_mode, test_env=False):
        if eval_mode == "color_hard":
            eval_episodes = 10
        elif eval_mode == "video_easy":
            eval_episodes = 10
        elif eval_mode == "video_hard":
            eval_episodes = 100
        episode_rewards = []
